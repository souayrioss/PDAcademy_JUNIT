      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-12 col-lg-12">
            <div class="card">
              <div class="card-header d-flex justify-content-between"><p></p> <a class="btn-success" href="create-participant">add participant</a></div>
              <div class="card-body">
                ...
                <table class="table table-hover" id="dataTables-example" width="100%">
                  ...
                  <c:forEach items="${participants}" var="participant">
                    <tr>
                      ...
                      <td>
                        <a class="btn-info" href="edit-responsible?id=<c:out value='${participant.id}' />">Edit</a>
                        &nbsp;&nbsp;&nbsp;&nbsp;
                        <a class="btn-danger" href="delete-responsible?id=<c:out value='${participant.id}' />">Delete</a>
                      </td>
                    </tr>
                  </c:forEach>
                  </tbody>
