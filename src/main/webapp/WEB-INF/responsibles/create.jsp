          ...
          <div class="col-lg-12">
            <div class="card">
              <div class="card-body">
                ...
                <form method="post" action="insert-responsible" class="needs-validation" novalidate accept-charset="utf-8">
                  <div class="row g-2">
                    <div class="mb-3 col-md-6">
                      <label  class="form-label">Responsible first name</label>
                      <input type="text" class="form-control" name="first-name" placeholder="title" required>
                    </div>
                    <div class="mb-3 col-md-6">
                      <label  class="form-label">Responsible last name</label>
                      <input type="text" class="form-control" name="last-name" placeholder="title" required>
                    </div>
                  </div>
                  <div class="row g-2">
                    <div class="mb-3 col-md-6">
                      <label  class="form-label">phone number</label>
                      <input type="tel" class="form-control" name="phone-number" placeholder="title" required>
                    </div>
                    <div class="mb-3 col-md-6">
                      <label  class="form-label">company</label>
                      <input type="text" class="form-control" name="domain" placeholder="title" required>
                    </div>
                  </div>
<%--                  selects--%>
                  <div class="row g-2">
                    ...
                    <div class="mb-3 col-md-4">
                      ...
                      <select name="responsible-type" class="form-control" required>
